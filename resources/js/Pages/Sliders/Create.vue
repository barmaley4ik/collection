      ...
      <form @submit.prevent="submit">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          ...
          <div class="flex w-full flex-col pb-8 pr-6"  v-show="lang == current_locale" :key=" 'text_slider' + lang "> 
            ...
            <div v-if="error_msg['text_slider.'+lang]" class="form-error">{{ error_msg['text_slider.'+lang][0] }}</div> 
          </div>            
          </template>
...
export default {
  ...
  created() {
    ...
    this.langs.forEach((item, i, langs)=> {
      ...
      Vue.set( this.form.text_slider,item, '');
  ...
  methods: {
    submit() {
      this.sending = true
      this.$inertia.post(this.route('sliders.store'), this.form)
