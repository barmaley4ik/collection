    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl">
      ...
      <form @submit.prevent="submit">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          ...
          <text-input v-model="form.phone" :errors="$page.errors.phone" class="pr-6 pb-8 w-full lg:w-1/2" label="Телефон" placeholder="+38(067) 1234-567" />
...
export default {
  metaInfo: { title: 'Создать заявку на участие' },
  layout: Layout,
  components: {
    LoadingButton,
    TextInput,
...
/*   directives: { VueMaskDirective},   */
  ...
  methods: {
    ...
    submit() {
      this.sending = true
      this.$inertia.post(this.route('proposals.store'), this.form)
