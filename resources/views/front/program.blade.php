...
@section('meta')
<title>{{ __('front.program') }} {{ $festival->name }}</title>
{{-- <meta name="description" content="{{ __('front.program') }} {{ $festival->name }}" /> --}}
@endsection 
@section('content')
                                            ...
                                            <div class='wolf-row-inner' style='padding-top:15px;padding-bottom:5px;'>
                                                <div class="wrap">
                                                    <div class="col-12 wolf-col">
                                                        ...
                                                        <h5 style='line-height:1;font-weight:500;letter-spacing:0px;text-transform:uppercase;' class='fittext text-center clearfix' data-max-font-size='36'>{{ __('front.program') }} {{ $festival->name }}</h5>
                                                        </div> 
                                                    </div> 
                                                </div><!--.wrap-->
                                            </div><!--.wolf-row-inner-->
                                        </div><!--.wolf-row-->
                                        @each('front.components.program', $festival->programs, 'program')
                                        @endif
                                        <br>
                                        <br>
