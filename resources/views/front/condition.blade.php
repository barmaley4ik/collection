...
@section('meta')
<title>{{ $festival->condition->meta_title }}</title>
    <meta name="description" content="{{ $festival->condition->meta_description }}" />
@endsection 
@section('content')
                                                ...
                                                <div class="wrap">
                                                    <div class="col-12   wolf-col">
                                                        <div class="wpb_wrapper">
                                                            <h5 style='line-height:1;font-weight:500;letter-spacing:0px;text-transform:uppercase;color:#ffffff; line-height: 2.5; padding-top: 30px; margin-bottom: 0px; padding-bottom: 30px;' class='fittext text-center clearfix wow fadeIn' data-max-font-size='24'>{{ $festival->condition->header }}</h5>
                                                        </div> 
                                                    </div> 
                                                </div><!--.wrap-->
                                            </div><!--.wolf-row-inner-->
                                        </div><!--.wolf-row-->
                                        @include('front.components.condition')
                                        @endif
                                        <br>
                                        <br>
