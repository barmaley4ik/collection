  ...
  <div>
    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl">
      <div class="bg-white border-none w-full p-4 md:py-0 md:px-8 text-md md:text-md flex justify-end items-center" >
        <!-- <div class="mt-5 mr-5" v-for="lang of langs">{{lang}}</div>  -->
...
export default {
  ...
  created() {
    ...
    var obj= {};
    langs.forEach(function(item, i, langs) {
       obj[item]='';
       return obj;
    });
  ...
  methods: {
    submit() {
      this.sending = true
      this.$inertia.post(this.route('languages.store'), this.form)
